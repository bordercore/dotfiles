...
Enable highlight-indent-guides for Python
#+BEGIN_SRC emacs-lisp
(use-package highlight-indent-guides
  :config
  ;; Use "column" display method
  (setq highlight-indent-guides-method 'column)

  ;; Enable a Responsive Guide to visualize not only the indentation itself, but your place in it
  (setq highlight-indent-guides-responsive 'top)

  ;; Enable this mode when coding
